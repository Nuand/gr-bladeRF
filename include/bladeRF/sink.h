...
#ifndef INCLUDED_BLADERF_SINK_H
  ...
  namespace bladeRF {
    ...
    class BLADERF_API sink : virtual public common_hier_block
    {
     public:
      ...
      /*!
       * \brief Return a shared_ptr to a new instance of bladeRF::sink.
       *
       * To avoid accidental use of raw pointers, bladeRF::sink's
       * constructor is in a private implementation
       * class. bladeRF::sink::make is the public interface for
